...
- jk - жк или подборка
- status_client - статус клиента (0 - заявка, 1 - общение, 2 - договор, 3 - завершен успешно, 4 - завершен неудачно)
- status_order - статус заявки (0 - заявка, 1 - отклонена, 2 - выполнено)
- comment - коммен
- token - токен
...
- client_text - текст клиента
- jk - жк или подборка
- status_client - статус клиента (0 - заявка, 1 - общение, 2 - обсуждение, 3 - договор, 4 - завершен успешно, 5 - завершен неудачно)
- status_order - статус заявки (0 - заявка, 1 - отклонена, 2 - выполнено)
- comment - коммен
- token - токен
