            ...
            <div class="flex flex-col gap-4 xxl:gap-3 xl:gap-2.5">
              <div class="flex gap-3 xxl:gap-2 xl:gap-1.5">
                <div class="flex flex-col gap-1 xxl:gap-0.5">
                  <span class="font-semibold text-[13px] xxl:text-[11px] xl:text-[10px] lg:text-[13px]">{{ item.house.title }}</span>
              ...
              <p class="text-sm xxl:text-xs xl:text-[10px] lg:text-[14px]">{{ item.title }}</p>
            </div>
