<template>
  <div class="bg-[#F6F3FA] p-7 xxl:p-5 xl:p-5 h-fit mb-10 xxl:mb-8 xl:mb-6 rounded-[10px]">
    <div class="text-sm xxl:text-xs xl:text-[10px] lg:text-[13px] pb-10 xxl:pb-8 xl:pb-6" v-if="news.length > 0">
      <span class="font-medium text-lg xxl:text-[15px] xl:text-[13px] lg:text-[16px] pt-6 xxl:pt-5 xl:pt-4">{{ language.ob[0] }}</span>
      ...
      <div class="flex justify-center w-full pt-5 xxl:pt-4 xl:pt-3">
        <button @click="$emit('open-all-news')" class="flex items-center gap-2.5 xxl:gap-2 xl:gap-1.5 animation__arrow">
          <span class="text-[#6435A5] text-sm xxl:text-xs xl:text-[10px] lg:text-[13px]">{{ language.ob[14] }} ({{ house.news.length }})</span>
    ...
    <div class="pb-10 xxl:pb-8 xl:pb-6">
      <div class="font-medium text-lg xxl:text-[15px] xl:text-[13px] lg:text-[16px] pb-5 xxl:pb-4 xl:pb-3 leading-none">{{ language.rielt_1[23] }}</div>
...
<!--          <img :src="'/storage/' + house.user.image" class="h-14 xxl:h-12 xl:h-10" alt="avatar">-->
    ...
    <div class="pb-10 xxl:pb-8 xl:pb-6" v-if="house.info.exclusive && house.info.exclusive !== 'null'">
      <div class="font-medium text-lg xxl:text-[15px] xl:text-[13px] lg:text-[16px] pb-5 xxl:pb-4 xl:pb-3 leading-none">{{ language.ob[2] }}:</div>
    ...
    <div class="pb-14 xxl:pb-10 xl:pb-8">
      ...
      <div class="flex items-start gap-4 xxl:gap-3 xl:gap-2.5">
        <span class="font-medium text-[32px] xxl:text-[26px] xl:text-[22px] lg:text-[26px]" v-if="user.subscription_info.free === 0 && house.percent !== 'null'">{{ house.percent + '%' }}</span>
    ...
    <div class="pb-14 xxl:pb-10 xl:pb-8" v-if="house.supports.length > 0">
      <div class="font-medium text-lg xxl:text-[15px] xl:text-[13px] lg:text-[16px] pb-5 xxl:pb-4 xl:pb-3 leading-none">{{ language.ob[4] }}</div>
      <div class="bg-white p-4 xxl:p-3 xl:p-2.5 rounded-[10px] mb-3" v-for="item in house.supports">
        <div class="flex items-center gap-5 xxl:gap-4 xl:gap-3 pb-5 xxl:pb-4 xl:pb-3">
          <img class="w-14 xxl:w-12 xl:w-10 h-14 xxl:h-12 xl:h-10 rounded-full object-cover" v-if="item.avatar.length > 17" :src="item.avatar" alt="">
    ...
    <div class="" v-if="house.files.length > 0">
      <div class="font-medium text-lg xxl:text-[15px] xl:text-[13px] lg:text-[16px] pb-5 xxl:pb-4 xl:pb-3 leading-none">{{ language.ob[5] }}</div>
