<template>
  <div class="bg-[#F6F3FA] p-7 xxl:p-5 xl:p-5 h-fit mb-10 xxl:mb-8 xl:mb-6 rounded-[10px]">
    ...
    <div class="pb-10 xxl:pb-8 xl:pb-6">
      <div class="font-medium text-lg xxl:text-[15px] xl:text-[13px] lg:text-[16px] pb-5 xxl:pb-4 xl:pb-3 leading-none">Застройщик</div>
...
<!--          <img :src="'/storage/' + house.user.image" class="h-14 xxl:h-12 xl:h-10" alt="avatar">-->
    ...
    <div class="pb-14 xxl:pb-10 xl:pb-8" v-if="house.supports.length > 0">
      <div class="font-medium text-lg xxl:text-[15px] xl:text-[13px] lg:text-[16px] pb-5 xxl:pb-4 xl:pb-3 leading-none">Контакты</div>
      <div class="bg-white p-4 xxl:p-3 xl:p-2.5 rounded-[10px] mb-3" v-for="item in house.supports">
        <div class="flex items-center gap-5 xxl:gap-4 xl:gap-3 pb-5 xxl:pb-4 xl:pb-3">
          <img class="w-14 xxl:w-12 xl:w-10 h-14 xxl:h-12 xl:h-10 rounded-full" v-if="item.avatar.length < 17" :src="item.avatar" alt="">
          <img class="w-14 xxl:w-12 xl:w-10 h-14 xxl:h-12 xl:h-10 rounded-full" v-else src="../../assets/no-img-houses.jpg" alt="">
