...
<!--              </div>-->
          ...
          <div class="relative mb-5 xxl:mb-4 xl:mb-3">
            <div @click="openFilt = !openFilt" class="cursor-pointer flex justify-between items-center text-[#1E1D2D] text-[17px] xxl:text-[14px] xl:text-[12px] lg:text-[15px] mb-5 xxl:mb-4 xl:mb-3 leading-none">
              <span class="hover__title-block">Фильтры</span>
              <img :class="{'rotate-180': openFilt}" class=" transition-all w-3 xxl:w-2.5 xl:w-2" src="../../assets/svg/arrow_down_black.svg" alt="">
            </div>
            <div v-if="openFilt" class="flex flex-col gap-4 xxl:gap-3 xl:gap-2.5">
