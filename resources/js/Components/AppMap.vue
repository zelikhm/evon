...
{{city}}
   <GMapMap :center="city !== null ? city : center" :disableDefaultUI="false" :zoom="city !== null ? 10 : 6" map-type-id="roadmap" class="w-full h-[90vh]"
            :options="{
                      zoomControl: false,
...
<script>
export default {
  props: ['houses_array', 'state', 'user', 'type', 'city'],
  data() {
    return {
      openedMarkerID: null,
