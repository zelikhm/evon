  ...
  <div class="fixed z-[100] w-full h-full flex items-center lg:items-start">
    <div class="relative z-50 left-[10vw] w-[60%] lg:w-full lg:left-0 lg:px-5 lg:mt-10">
      ...
      <div class="absolute top-0 lg:top-full left-[102%] lg:left-1/2 lg:-translate-x-1/2 lg:mt-5 w-[36%] lg:w-fit flex flex-col h-fit gap-4 xxl:gap-3 xl:gap-2">
        <button class="bg-white flex justify-between gap-5 xxl:gap-4 xl:gap-3 items-center p-7 xxl:p-5 xl:p-4 lg:p-3 rounded-[10px] news__line">
          <span class="text-[#1E1D2D] text-lg xxl:text-[15px] xl:text-[13px] leading-none whitespace-nowrap">3D Рендеры</span>
          <span class="text-[#8A8996] text-[14px] xxl:text-[12px] xl:text-[10px] whitespace-nowrap">17 фото</span>
        </button>
        <button class="bg-white flex justify-between gap-5 xxl:gap-4 xl:gap-3 items-center p-7 xxl:p-5 xl:p-4 lg:p-3 rounded-[10px] news__line">
          <span class="text-[#1E1D2D] text-lg xxl:text-[15px] xl:text-[13px] leading-none whitespace-nowrap">Инфраструктура</span>
          <span class="text-[#8A8996] text-[14px] xxl:text-[12px] xl:text-[10px] whitespace-nowrap">17 фото</span>
        </button>
        <button class="bg-white flex justify-between gap-5 xxl:gap-4 xl:gap-3 items-center p-7 xxl:p-5 xl:p-4 lg:p-3 rounded-[10px] news__line">
          <span class="text-[#1E1D2D] text-lg xxl:text-[15px] xl:text-[13px] leading-none whitespace-nowrap">Дизайн</span>
          <span class="text-[#8A8996] text-[14px] xxl:text-[12px] xl:text-[10px] whitespace-nowrap">17 фото</span>
        </button>
        <button class="bg-white flex justify-between gap-5 xxl:gap-4 xl:gap-3 items-center p-7 xxl:p-5 xl:p-4 lg:p-3 rounded-[10px] news__line">
          <span class="text-[#1E1D2D] text-lg xxl:text-[15px] xl:text-[13px] leading-none whitespace-nowrap">Ход строительства</span>
          <span class="text-[#8A8996] text-[14px] xxl:text-[12px] xl:text-[10px] whitespace-nowrap">17 фото</span>
        </button>
      </div>
    </div>
