            ...
            <div class="sm:overflow-auto sm:custom__scroll-grey">
              <div class="flex flex-col sm:w-[360px]">
                <div class="border__top grid grid__apart-have items-center py-5 xxl:py-4 xl:py-3"
                  ...
                  <div>
                    <span class="text-[16px] xxl:text-[14px] xl:text-[12px] whitespace-nowrap leading-none">{{ item.number }}</span>
                  </div>
                  <div>
        ...
        <div class="sticky top-[40px] h-fit">
          <div class="contact__selling h-fit bg-white rounded-[10px] p-4 xxl:p-3 xl:p-2.5 mb-7 xxl:mb-5 xl:mb-4">
            <div class="flex items-center gap-5 xxl:gap-4 xl:gap-3 mb-5 xxl:mb-4 xl:mb-4">
              <img class="w-14 xxl:w-12 xl:w-10 h-14 xxl:h-12 xl:h-10 rounded-full object-cover" v-if="compilation.user.image"
            ...
            <div class="flex flex-col gap-4 xxl:gap-3 xl:gap-2.5">
              <div class="flex cursor-pointer bg-[#F6F3FA] p-4 xxl:p-3 xl:p-2.5 rounded-[5px]">
                ...
                <span
                  class="leading-none text-center w-full text-[#6536A5] text-[16px] xxl:text-[14px] xl:text-[12px] lg:text-[14px]">{{ compilation.user.phone }}</span>
              </div>
              <div class="flex cursor-pointer bg-[#F6F3FA] p-4 xxl:p-3 xl:p-2.5 rounded-[5px]"
