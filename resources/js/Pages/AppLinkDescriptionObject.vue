...
<template>
  <header class="relative h-[13.4vw]">
    <img v-if="compilation.company" class="w-full absolute top-0 left-0 h-full" src="../../assets/bg_links.jpg" alt="">
    ...
    <div class="_container flex h-full">
      <div class="self-end flex items-center gap-7 xxl:gap-6 xl:gap-5 mb-10 xxl:mb-8 xl:mb-6">
        <div v-if="compilation.company" class="flex-shrink-0 bg-black w-20 xxl:w-16 xl:w-12 h-20 xxl:h-16 xl:h-12 rounded-full flex items-center justify-center">
        ...
        <div class="text-white flex flex-col gap-2 xxl:gap-1.5 xl:gap-1">
          <span class="text-[30px] xxl:text-[25px] xl:text-[20px] font-bold leading-none" v-if="compilation.company">{{ compilation.company.title }}</span>
