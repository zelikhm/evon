<template>
  <header class="relative h-[13.4vw]">
    <img v-if="compilation.company === null || compilation.company.banner === null || compilation.company.banner === 'undefined'" class="w-full absolute top-0 left-0 h-full 1" src="../../assets/bg_links.jpg" alt="">
