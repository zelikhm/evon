      ...
      <div class="grid__68-30 justify-between" v-if="!map">
        <div class="w-full flex flex-col">
          ...
          <div class="flex flex-col pb-14 xxl:pb-10 xl:pb-8">
            ...
            <p class="text-[#8A8996] text-base xxl:text-sm xl:text-xs pb-6 xxl:pb-5 xl:pb-4" v-if="fullDescription && house.description.length < 1000" v-html="house.description"></p>
