<template>
  <app-header :user="user" @update-block-client="updateBlockClient" :language="language" @selectLanguage="choseLanguage" />
  <app-modal-album
    v-if="album"
    :image="house.images"
  ...
  <main v-if="!chess">
    <div class="_container flex flex-col">
        ...
        <div class="flex lg:flex-col items-center justify-between">
          ...
          <div class="flex flex-col p-4 xxl:p-3 xl:p-2">
            <div class="flex items-center lg:justify-center gap-5 xxl:gap-4 xl:gap-3">
              ...
              <div class="flex whitespace-nowrap items-center gap-2 xxl:gap-1.5 xl:gap-1 text-[14px] xxl:text-[12px] xl:text-[10px] lg:text-[14px]">
            ...
            <span class="text-[#8A8996] text-center text-sm xxl:text-xs xl:text-[10px] lg:text-[14px]">{{ selectLanguage === 0 ? city_name.title : selectLanguage === 1 ? city_name.title_en : city_name.title_tr }}, {{ area_name !== undefined ? selectLanguage === 0 ? area_name.title : selectLanguage === 1 ? area_name.title_en : area_name.title_tr : '' }}</span>
          </div>
          ...
          <div class="flex lg:flex-col lg:items-center h-20 xxl:h-16 xl:h-12 lg:h-fit">
            <div class="border__right lg:border-0 flex items-center lg:flex-col gap-5 xxl:gap-4 xl:gap-3 p-4 xxl:p-3 xl:p-2">
              ...
              <div @click="map = !map" class="button__map text-[#6435A5]  flex items-center justify-center cursor-pointer bg-[#F6F3FA] gap-2 xxl:gap-1.5 xl:gap-1 h-10 xxl:h-8 xl:h-6 lg:h-8 px-4 xxl:px-3 xl:px-2.5 rounded-[4px]">
                ...
                <span class="text-sm xxl:text-xs xl:text-[10px] lg:text-[15px] leading-none">{{ map ? language.menu_zastr_1[11] : language.rielt_1[6] }}</span>
              </div>
            </div>
      ...
      <div class="grid__68-30 justify-between" v-if="!map">
        <div class="w-full flex flex-col">
          ...
          <div class="border border-solid border-[#E5DFEE] h-[100px] xxl:h-[80px] xl:h-[60px] sm:h-fit flex items-center sm:flex-col justify-evenly rounded-[12px] mt-7 xxl:mt-5 xl:mt-4 mb-16 xxl:mb-12 xl:mb-10">
            ...
            <div class="flex flex-col justify-center sm:p-2">
              ...
              <span class="text-center text-[#8A8996] text-[13px] xxl:text-[11px] xl:text-[9px] lg:text-[13px]">{{ language.dob_kv_1[17] }}</span>
            </div>
            <div class="h-full w-[1px] sm:h-[1px] sm:w-full bg-[#E5DFEE]"></div>
            <div class="flex flex-col justify-center sm:p-2">
              ...
              <span class="text-center text-[#8A8996] text-[13px] xxl:text-[11px] xl:text-[9px] lg:text-[13px]">{{ language.rielt_1[56] }} м²</span>
            </div>
            <div class="h-full w-[1px] sm:h-[1px] sm:w-full bg-[#E5DFEE]"></div>
            <div class="flex flex-col justify-center sm:p-2">
              ...
              <span class="text-center text-[#8A8996] text-[13px] xxl:text-[11px] xl:text-[9px] lg:text-[13px]">{{ language.rielt_1[57] }}</span>
            </div>
            <div class="h-full w-[1px] sm:h-[1px] sm:w-full bg-[#E5DFEE]"></div>
            <div class="flex flex-col justify-center sm:p-2">
            ...
            <div class="border border-solid border-[#E5DFEE] p-7 xxl:p-5 xl:p-4 rounded-[12px]">
              ...
              <div class="flex flex-col gap-5 xxl:gap-4 xl:gap-3 pt-6 xxl:pt-5 xl:pt-4">
                ...
                <div class="flex justify-between items-center" v-if="house.info.toShop !== null">
                  <span class="text-[#8A8996] text-base xxl:text-sm xl:text-xs lg:text-[15px]">{{ language.rielt_1[28] }}</span>
                ...
                <div class="flex justify-between items-center" v-if="house.info.toChildrenSchool !== null">
                  <span class="text-[#8A8996] text-base xxl:text-sm xl:text-xs lg:text-[15px]">{{ language.rielt_1[29] }}</span>
                ...
                <div class="flex justify-between items-center" v-if="house.info.toPark !== null">
                  <span class="text-[#8A8996] text-base xxl:text-sm xl:text-xs lg:text-[15px]">{{ language.rielt_1[33] }}</span>
                ...
                <div class="flex justify-between items-center" v-if="house.info.toBus !== null">
                  <span class="text-[#8A8996] text-base xxl:text-sm xl:text-xs lg:text-[15px]">{{ language.rielt_1[34] }}</span>
                ...
                <div class="flex justify-between items-center" v-if="house.info.toSchool !== null">
                  <span class="text-[#8A8996] text-base xxl:text-sm xl:text-xs lg:text-[15px]">{{ language.rielt_1[30] }}</span>
        ...
        <app-decrition-object-sidebar class="w-full" v-if="!isWithClient" @open-all-news="openAllNews = true" :house="house" :language="language" />
      </div>
    </div>
