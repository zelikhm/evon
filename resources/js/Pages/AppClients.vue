...
<template>
    <app-modal-change-client :user="user" @close-create-selection="closeCreateSelection" :openSideBar="openSideBar"
        :tool="tool" v-if="openChangeClient" :openChangeClient="openChangeClient" :language="language" />
        ...
        <div class="_container">
            <div class=" h-20 xxl:h-16 xl:h-12 lg:h-fit rounded-[12px] my-7 xxl:my-5 xl:my-4">
                <div class="flex lg:flex-col items-center justify-between">
                    <div class="flex flex-col p-4 xxl:p-3 xl:p-2">
                        <div class="flex items-center lg:justify-center gap-5 xxl:gap-4 xl:gap-3"><span class="font-semibold text-xl xxl:text-lg xl:text-sm lg:text-[19px]">Мои клиенты </span> </div>
                    ...
                    <div class="flex lg:flex-col lg:items-center h-20 xxl:h-16 xl:h-12 lg:h-fit">
                        <div class="flex items-center p-4 xxl:p-3 xl:p-2">
                            <button @click="openSelection(), tool = 1"  class="login__btn--bg bg-[#E84680] px-4 xxl:px-4 xl:px-2.5 rounded-[3px] h-10 xxl:h-8 xl:h-6 font-semibold text-white text-base xxl:text-[13px] xl:text-[11px] lg:text-[15px] leading-none">
            ...
            <div class="flex flex-col pb-7 xxl:pb-5 xl:pb-4"> 
                <p class="text-[#8A8996] text-base xxl:text-sm xl:text-xs pb-6 xxl:pb-5 xl:pb-4">
                  <span style="color: rgb(0, 0, 0);">Добавьте своих клиентов для помощи в сопровождении сделки или свяжитесь с нашим менеджером по вопросам  проведения дистанционных сделок </span>
                </p> 
            </div> 
            <div class="columns-clients"> 
                <div class="clients-list">
                    <div class="client w-1/3 md:w-1/4 lg:w-1/5 mb-8 bg-white shadow-md rounded-lg relative z-10 text-sm md:text-base">
                        <div class="info p-4">
                            <div class="flex justify-between items-center mb-4">
                                <div class="text-lg font-bold"></div>
                                <div class="flex gap-2">
                                    <button @click="openSelection(), tool = 2" class="p-2">
                                        <img src="../../assets/svg/pen_icon_grey.svg" class="w-6 h-6" alt="">
                                    </button>
                                    <button @click="deleteConfirm = true" class="p-2">
                            ...
                            <div class="text-xs font-bold mb-2">Заинтересован в: <span class="font-normal"></span></div>
                            <div class="text-xs font-bold mb-2">Статус клиента: <span class="font-normal"></span> </div>
                            <div class="text-xs font-bold mb-2">Партнер: <span class="font-normal"></span></div>
                           ...
                           <!--  <div class="text-xs font-bold mb-2">Комментарий: <span class="font-normal">Комментарий</span> </div> -->
                            <div v-if="deleteConfirm"  class="cursor-auto z-20 w-full text-sm lg:text-base absolute top-1/4 bg-white right-0 flex flex-col border border-solid border-purple-400 rounded-lg ">
                                ...
                                <div class="cursor-pointer flex">
                                    <div class="hover__select w-full text-center border__right p-2.5 xxl:p-2 xl:p-1.5 leading-none text-[red]"
                                        @click="deleteCompilation()">
                                        {{ language.default[0] }}
                                    </div>
            ...
            <div class="flex flex-col pt-7 pb-7 xxl:pb-5 xl:pb-4"> 
                <p class="text-[#8A8996] text-base xxl:text-sm xl:text-xs pb-6 xxl:pb-5 xl:pb-4">
                  <span style="color: rgb(0, 0, 0);">После добавления клиента, менеджер Evon свяжется с вами для подбора партнера в сопровождении сделки </span>
                </p> 
            </div> 
        </div>
    </main>
