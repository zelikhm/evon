    ...
    <main class="">
      <div class="_container">
        <div class="flex justify-between items-center my-4 xxl:my-3 xl:my-2.5">
          <div class="grid grid-cols-5 gap-3 xxl:gap-2.5 xl:gap-2">
            <div class="corpus__banner border border-solid border-[#6435A5] w-[9.5vw] gap-3.5 xxl:gap-3 xl:gap-2.5 cursor-pointer rounded-[5px] flex flex-col justify-center p-4.5 xxl:p-3.5 p-2.5">
            ...
            <div class="corpus__banner w-[9.5vw] gap-3.5 xxl:gap-3 xl:gap-2.5 cursor-pointer rounded-[5px] flex flex-col justify-center p-4.5 xxl:p-3.5 x:p-2.5">
              <span class="text-[#1E1D2D] text-lg xxl:text-[15px] xl:text-[13px] leading-none">Корпус 1</span>
              <span class="text-[#8A8996] text-sm xxl:text-xs xl:text-[10px] leading-none">0 квартир</span>
            </div>
            <div class="corpus__banner w-[9.5vw] gap-3.5 xxl:gap-3 xl:gap-2.5 cursor-pointer rounded-[5px] flex flex-col justify-center p-4.5 xxl:p-3.5 x:p-2.5">
          ...
          <div class="flex items-center gap-7 xxl:gap-5 xl:gap-4">
            <div class="flex items-center gap-2 xl:gap-1.5">
              ...
              <span class="text-[14px] xxl:text-[12px] xl:text-[10px] leading-none">05.12.2022</span>
            </div>
      ...
      <div class="grid grid__chess">
        ...
        <div>
          <div class="border__bottom">
            <div class="mr-[6.25vw] flex justify-between p-14 xxl:p-10 xl:p-8">
          ...
          <div class="flex items-center justify-center mr-[6.25vw]">
